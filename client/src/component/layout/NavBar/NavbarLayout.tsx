    ...
    <>
      <div className={Style.container}>
        ...
        <div className={Style.mid}>
          <div className={Style.mid_man}>
            <span className={Style.logo_bg}>
              <a href="https://www.asos.com/men/" className={Style.logo} data-testid="asoslogo">
            ...
            <div className={Style.mid_left}>
              <ul className={Style.gioitinh}>
                <li className={Style.gender}>
                  <span>WOMEN</span>
                </li>
                <li className={Style.gender}>
                  <span>MEN</span>
              ...
              <div className={Style.mid_search}>  
                <div className={Style.mid_input}>
                 <InputSearchCommon
                    className={Style.mid_input_text}
                  ...
                  <div className={Style.mid_right_group}>
                    <button className={Style.widgets}>
                      <BsPerson className={Style.widgets_icon} />
                    </button>
                    <button className={Style.widgets}>
                      <AiOutlineHeart className={Style.widgets_icon} />
                    </button>
                    <button className={Style.widgets}>
                      <RiShoppingBagLine className={Style.widgets_icon} />
                    </button>
                  </div>
                </div>
              </div>
